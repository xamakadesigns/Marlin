...
#define FAN_KICKSTART_TIME 100 // MAS good for low fan speeds
...
#define HOMING_BUMP_MM      { 5, 5, 5 }       // mas (mm) Backoff from endstops after first bump
                                              // mas For delta all values must be the same
#define HOMING_BUMP_DIVISOR { 10, 10, 10 }       // mas Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_SET_PROGRESS_MANUALLY // mas
 ...
 */
// mas enable the emergency parser!
// mas not yet supported!
