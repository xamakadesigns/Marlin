...
/**
 * Host Serial Port
 * If your touch screen sends line numbers it can mess with host printing.
 * Use this option to ignore line numbers sent by the LCD, etc.
 *  1 = SERIAL_PORT
 *  2 = SERIAL_PORT_2
 * -1 = Allow line numbers from all serial ports
 */
